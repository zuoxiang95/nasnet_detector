...
from nasnet.RoiPoolingConv import RoiPoolingConv
...
def rpn(base_layers,num_anchors):
    ...
    x = SeparableConv2D(512, (3, 3), padding='same', activation='relu', kernel_initializer='normal', name='rpn_conv1')(base_layers)

    x_class = SeparableConv2D(num_anchors, (1, 1), activation='sigmoid', kernel_initializer='uniform', name='rpn_out_class')(x)
    x_regr = SeparableConv2D(num_anchors * 4, (1, 1), activation='linear', kernel_initializer='zero', name='rpn_out_regress')(x)
...
#         bn_axis = 1
#
#     conv_name_base = 'nas' + str(stage) + block + '_branch'
#     bn_name_base = 'bn' + str(stage) + block + '_branch'
#
#     x = TimeDistributed(SeparableConv2D(nb_filter1, (1, 1), trainable=trainable, kernel_initializer='normal'), name=conv_name_base + '2a')(input_tensor)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2a')(x)
#     x = Activation('relu')(x)
#
#     x = TimeDistributed(SeparableConv2D(nb_filter2, (kernel_size, kernel_size), trainable=trainable, kernel_initializer='normal',padding='same'), name=conv_name_base + '2b')(x)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2b')(x)
#     x = Activation('relu')(x)
#
#     x = TimeDistributed(SeparableConv2D(nb_filter3, (1, 1), trainable=trainable, kernel_initializer='normal'), name=conv_name_base + '2c')(x)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2c')(x)
#
...
#     bn_name_base = 'bn' + str(stage) + block + '_branch'
#
#     x = TimeDistributed(SeparableConv2D(nb_filter1, (1, 1), strides=strides, trainable=trainable, kernel_initializer='normal'), input_shape=input_shape, name=conv_name_base + '2a')(input_tensor)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2a')(x)
#     x = Activation('relu')(x)
#
#     x = TimeDistributed(SeparableConv2D(nb_filter2, (kernel_size, kernel_size), padding='same', trainable=trainable, kernel_initializer='normal'), name=conv_name_base + '2b')(x)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2b')(x)
#     x = Activation('relu')(x)
#
#     x = TimeDistributed(SeparableConv2D(nb_filter3, (1, 1), kernel_initializer='normal'), name=conv_name_base + '2c', trainable=trainable)(x)
#     x = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '2c')(x)
#
#     shortcut = TimeDistributed(SeparableConv2D(nb_filter3, (1, 1), strides=strides, trainable=trainable, kernel_initializer='normal'), name=conv_name_base + '1')(input_tensor)
#     shortcut = TimeDistributed(BatchNormalization(axis=bn_axis, momentum=_BN_DECAY, epsilon=_BN_EPSILON), name=bn_name_base + '1')(shortcut)
#
